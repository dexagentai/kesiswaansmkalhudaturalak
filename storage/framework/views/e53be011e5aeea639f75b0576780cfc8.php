...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark no-print">
        <div class="container">
            <a class="navbar-brand d-flex align-items-center" href="/">
                <img src="<?php echo e(asset('images/logo_alhuda.png')); ?>" alt="Logo SMK AL HUDA TURALAK">
                SMK AL HUDA TURALAK
            </a>
    ...
    <footer class="text-center text-muted no-print">
        &copy; <?php echo e(date('Y')); ?> SMK AL HUDA TURALAK — Sistem Kesiswaan Terintegrasi
    </footer>
...
<?php /**PATH C:\xampp\absensi-web\resources\views/layout.blade.php ENDPATH**/ ?>